...
public interface InteractionMapper {
    ...
    UserQuery selectUserQueryById(@Param("id") long id);

    List<UserQuery> selectUserQueryWithPageNum(@Param("userId") long userId, @Param("offset")int offset, @Param("num") int num);

    int countUserQueryByUserId(@Param("userId") long userId);
